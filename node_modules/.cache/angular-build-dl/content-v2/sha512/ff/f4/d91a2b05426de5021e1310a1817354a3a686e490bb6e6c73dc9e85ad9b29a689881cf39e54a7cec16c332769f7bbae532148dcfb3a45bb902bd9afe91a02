...
const routes = [
    ...
    {
        path: 'register',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-register-register-module */ "auth-register-register-module").then(__webpack_require__.bind(null, /*! ./auth/register/register.module */ "./src/app/auth/register/register.module.ts")).then(m => m.RegisterPageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'practice',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-practice-practice-module */ "practice-practice-module").then(__webpack_require__.bind(null, /*! ./pages/practice/practice.module */ "./src/app/pages/practice/practice.module.ts")).then(m => m.PracticePageModule)
    },
    {
        path: 'explore',
    ...
    {
        path: 'dictionary',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-dictionary-dictionary-module */ "dictionary-dictionary-module").then(__webpack_require__.bind(null, /*! ./pages/dictionary/dictionary.module */ "./src/app/pages/dictionary/dictionary.module.ts")).then(m => m.DictionaryPageModule)
    },
    {
        path: 'account',
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            _services_auth_guard_service__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"],
...
let AuthService = class AuthService {
    constructor(httpClient, storage, router, platform, toastController) {
        ...
        this.AUTH_SERVER_ADDRESS = 'https://radiant-woodland-34220.herokuapp.com';
        this.authSubject = new rxjs__WEBPACK_IMPORTED_MODULE_6__["BehaviorSubject"](false);
    ...
    register(user) {
        return this.httpClient.post(`${this.AUTH_SERVER_ADDRESS}/register`, user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res.user) {
                ...
                yield this.storage.set("user_name", res.user.name);
    ...
    ;
    login(user) {
        return this.httpClient.post(`${this.AUTH_SERVER_ADDRESS}/login`, user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res.user) {
                console.log("um");
    ...
    logout() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.storage.remove("user_id");
            yield this.storage.remove("user_name");
            yield this.storage.remove("user_email");
            yield this.storage.remove("my_dict");
            yield this.authState.next(false);
    ...
    ;
    addToDictionary(current_dict_object) {
        return this.httpClient.post(`${this.AUTH_SERVER_ADDRESS}/dictionary`, current_dict_object).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res) {
                yield console.log("responded!");
                console.log(res.user_dict);
            }
        })));
    }
    getUserDictionary(user_id) {
        return this.httpClient.post(`${this.AUTH_SERVER_ADDRESS}/dictionary_get`, user_id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])((res) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            if (res) {
                yield console.log("responded!");
                console.log(res.user_dict);
            }
...
module.exports = __webpack_require__(/*! /Users/paulgaudin/Desktop/Vocab_frontend/src/main.ts */"./src/main.ts");
