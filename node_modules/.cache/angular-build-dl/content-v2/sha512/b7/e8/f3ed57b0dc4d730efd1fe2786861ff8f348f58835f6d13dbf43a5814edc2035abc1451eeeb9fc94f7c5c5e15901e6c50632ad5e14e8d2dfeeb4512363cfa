...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
  ...
  function srcAppPagesAccountAccountPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AccountPage = /*#__PURE__*/function () {
      function AccountPage(httpClient, storage, authService, router) {
      ...
      _createClass(AccountPage, [{
        ...
        key: "ngOnInit",
        value: function ngOnInit() {// this.storage.get('user_name').then((user_name) => {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])], AccountPage);
    /***/
  }
}]);
